...
public class LimeLightConstants {
    ...
    public static class Setpoints {
        public static final double X_SETPOINT_ALINGMENT = -0.77;  
        public static final double Y_SETPOINT_ALINGMENT = 0;
        public static final double ROT_SETPOINT_ALINGMENT = -2;
    }

    public static class Tolerance {
        public static final double X_TOLERANCE_ALINGMENT = 0.05;
        public static final double Y_TOLERANCE_ALINGMENT = 0.02;
        public static final double ROT_TOLERANCE_ALINGMENT = 0.9; // 0.7
    }
